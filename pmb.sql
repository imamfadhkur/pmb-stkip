...
--
-- Host: 127.0.0.1
-- Generation Time: May 31, 2024 at 05:20 AM
...
(17, 'test jalur', '<p>-</p>', 100000, 0, 1, 'aktif', '2024-05-30 06:05:46', '2024-05-30 06:05:46');

-- --------------------------------------------------------

--
-- Table structure for table `jalur_masuk_prodis`
--

CREATE TABLE `jalur_masuk_prodis` (
  `id` bigint(20) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `jalur_masuk_prodis`
--

INSERT INTO `jalur_masuk_prodis` (`id`, `prodi_id`, `jalur_masuk_id`, `kuota`, `created_at`, `updated_at`) VALUES
(2, 5, 17, 10, '2024-05-30 06:05:46', '2024-05-30 06:05:46'),
(3, 6, 17, 5, '2024-05-30 06:05:46', '2024-05-30 06:05:46'),
(4, 7, 17, 5, '2024-05-30 06:05:46', '2024-05-30 06:05:46'),
(5, 8, 17, 5, '2024-05-30 06:05:46', '2024-05-30 06:05:46'),
(6, 9, 17, 0, '2024-05-30 06:05:46', '2024-05-30 08:48:36'),
(7, 10, 17, 10, '2024-05-30 06:05:46', '2024-05-30 06:05:46'),
(8, 11, 17, 10, '2024-05-30 06:05:46', '2024-05-30 06:05:46'),
(9, 5, 5, 5, '2024-05-30 08:52:15', '2024-05-30 08:52:15'),
(10, 6, 5, 5, '2024-05-30 08:52:15', '2024-05-30 08:52:15'),
(11, 7, 5, 5, '2024-05-30 08:52:15', '2024-05-30 08:52:15'),
(12, 8, 5, 5, '2024-05-30 08:52:15', '2024-05-30 08:52:15'),
(13, 9, 5, 5, '2024-05-30 08:52:15', '2024-05-30 08:52:15'),
(14, 10, 5, 5, '2024-05-30 08:52:15', '2024-05-30 08:52:15'),
(15, 11, 5, 5, '2024-05-30 08:52:15', '2024-05-30 08:52:15');
...
(33, '2024_05_29_125939_create_jalur_masuk_prodis_table', 14);
...
--
-- Indexes for table `jalur_masuk_prodis`
--
ALTER TABLE `jalur_masuk_prodis`
  ADD PRIMARY KEY (`id`),
  ADD KEY `jalur_masuk_prodis_prodi_id_foreign` (`prodi_id`),
  ADD KEY `jalur_masuk_prodis_jalur_masuk_id_foreign` (`jalur_masuk_id`);
...
--
-- AUTO_INCREMENT for table `jalur_masuk_prodis`
--
ALTER TABLE `jalur_masuk_prodis`
...
--
-- Constraints for table `jalur_masuk_prodis`
--
ALTER TABLE `jalur_masuk_prodis`
  ADD CONSTRAINT `jalur_masuk_prodis_jalur_masuk_id_foreign` FOREIGN KEY (`jalur_masuk_id`) REFERENCES `jalur_masuks` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `jalur_masuk_prodis_prodi_id_foreign` FOREIGN KEY (`prodi_id`) REFERENCES `prodis` (`id`) ON DELETE CASCADE;
