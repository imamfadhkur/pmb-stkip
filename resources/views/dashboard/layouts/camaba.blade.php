...
@section('container')
    <div class="container my-5">
        ...
        <div class="row mb-4 no-print">
            <div class="col-md-12">
                <div class="p-4 bg-primary text-white rounded shadow-sm">
                    <h2 class="fw-bold">Selamat Datang, {{ $register->user->name }} 👋</h2>
                ...
                <div class="col-md-8" id="printableArea">
                    ...
                    <div class="card shadow-lg border-0" style="border-top: 5px solid #dc3545;">
                        <div class="card-body p-4 p-lg-5 text-center">
                            ...
                            <h4 class="text-muted mb-2">Biaya Pendaftaran</h4>
                            <h1 class="fw-bold text-danger display-4 mb-4">
                                Rp {{ $tagihan['nominal_tagihan'] }}
                            </h1>
                            ...
                            <div class="alert alert-light border border-dashed text-start d-inline-block w-100 mb-4 p-4 rounded-3">
                                <div class="row mb-2">
                                    ...
                                    <div class="col-6 text-end fw-bold">{{ $register->user->name }}</div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-6 text-muted">Nomor Invoice</div>
                                    <div class="col-6 text-end fw-bold">{{ $tagihan['nomor_invoice'] ?? '-' }}</div>
                                </div>
                                <div class="row mb-2">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-6 text-end fw-bold text-danger">{{ \Carbon\Carbon::parse($tagihan['tanggal_jatuh_tempo'])->translatedFormat('d F Y') }}</div>
                                </div>
                                <hr>
                                <div class="text-center mt-3">
                                    <p class="mb-1 text-muted small">Nomor Pembayaran</p>
                                    @php
        ...
        @else
            ...
            @php
                $pendaftar = $register->user->register;
            @endphp
