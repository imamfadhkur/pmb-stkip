  ...
  <div id="content" class="p-md-3">
    ...
    <div style="display: flex; align-items: center">
      ...
      <div style="margin-right: auto; margin-bottom: 0;">
        ...
        <a href="{{ url('register/create') }}" class="btn btn-sm btn-primary mb-2"><i class="bi bi-plus-square"></i> Tambah data pendaftar</a>
        
        <a href="{{ route('export.register') }}" class="btn btn-sm btn-success mb-2"><i class="bi bi-box-arrow-up-right"></i> Ekspor data</a>
        
        <button type="button" class="btn btn-sm btn-warning mb-2" data-bs-toggle="modal" data-bs-target="#generateDataModal">
          <i class="bi bi-gear"></i> Generate Data Siakad
        </button>
        ...
        <div class="modal fade" id="finalizeDataModal" tabindex="-1" aria-labelledby="finalizeDataModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="finalizeDataModalLabel">Finalize Data Siakad</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              </div>
              <div class="modal-body">
      ...
      <div style="margin-left: auto; margin-bottom: 0;">
        ...
        <form id="search-form" action="{{ url('register') }}" method="GET" class="d-flex mb-1">
            <div class="input-group">
              <input type="text" id="search" name="search" class="form-control" value="{{ request('search') }}" placeholder="Cari data...">
              <button type="button" class="btn btn-primary" disabled>Cari</button>
            </div>
        </form>           
